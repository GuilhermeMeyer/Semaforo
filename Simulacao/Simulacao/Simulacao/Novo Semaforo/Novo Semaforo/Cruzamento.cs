...
namespace Novo_Semaforo
{
    public partial class Cruzamento : Form
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (picVermelho2.Visible == true && picCarroBranco.Location.X <= 895 && picCarroBranco.Location.X > 851)
            {
                picCarroBranco.Left -= 0;
            }
            else if ((picVerde2.Visible == true && picVermelho1.Visible == true) || (picVermelho1.Visible && picVermelho2.Visible) == true && (picCarroBranco.Location.X > 865 || picCarroBranco.Location.X < 845))
            {
